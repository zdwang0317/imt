...
public class JsGridReportBase {
	 ...
	 * @throws Exception
	 */
	public HSSFWorkbook writeSheet(HSSFWorkbook wb, String title, HashMap<String, HSSFCellStyle> styles, String creator, TableData tableData,String subTitleName) throws Exception {
	 ...
	 */
	public void exportToExcel(String title, String creator, TableData tableData,String subTitleName)
			throws Exception {
		...
		wb = writeSheet(wb,title,styles,creator,tableData,subTitleName);//写入工作表
	 ...
	 *         bgcolor:#CAEAFE; </style>
	 */
	public void exportToExcel(String title, String creator, List<TableData> tableDataLst,String subTitleName)
		throws Exception {
		...
		for(TableData tableData : tableDataLst){
			...
			wb = writeSheet(wb,tableData.getSheetTitle(),styles,creator,tableData,subTitleName);//写入工作表
			i++;
		}
